        ...
        messages = [
            {
                ...
                "content": """Ты — игровой персонаж в симуляции.
                    ...
                    comment: 15 слов,
                    advice: 15–20 слов} Ничего больше присылать не нужно.
                    ...
                    "advice": "Сосредоточьтесь на усилении экспорта, снижении издержек и ускорении инвестиций, 
                    обеспечив прозрачный контроль за ключевыми секторами"}
